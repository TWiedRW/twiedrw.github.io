...
The book that got me into R is [R for Data Science](https://r4ds.had.co.nz) by Hadley Wickham and Garrett Grolemund. 
...
`broom` can transform model output into a dataframe, which I find helpful when writing reports when paired with `knitr::kable`
