...
In collaboration with Muxin Hua, we developed an R package focused on creating color palettes from images. The overall theory was to identify each color in the image and use clustering to find "average" colors for the desired number of ...
